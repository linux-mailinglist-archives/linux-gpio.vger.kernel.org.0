...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1A100DECD5
	for <lists+linux-gpio@lfdr.de>; Mon, 21 Oct 2019 14:53:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728263AbfJUMxd (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Mon, 21 Oct 2019 08:53:33 -0400
Received: from mga01.intel.com ([192.55.52.88]:39522 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727256AbfJUMxd (ORCPT <rfc822;linux-gpio@vger.kernel.org>);
        Mon, 21 Oct 2019 08:53:33 -0400
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga101.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 21 Oct 2019 05:53:32 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.67,323,1566889200"; 
   d="scan'208";a="280953997"
Received: from black.fi.intel.com ([10.237.72.28])
  by orsmga001.jf.intel.com with ESMTP; 21 Oct 2019 05:53:30 -0700
Received: by black.fi.intel.com (Postfix, from userid 1003)
        id A4C2A1C5; Mon, 21 Oct 2019 15:53:29 +0300 (EEST)
From:   Andy Shevchenko <andriy.shevchenko@linux.intel.com>
To:     Linus Walleij <linus.walleij@linaro.org>,
        linux-gpio@vger.kernel.org,
        Mika Westerberg <mika.westerberg@linux.intel.com>
Cc:     Andy Shevchenko <andriy.shevchenko@linux.intel.com>
Subject: [PATCH v1] pinctrl: intel: Add Intel Tiger Lake pin controller support
Date:   Mon, 21 Oct 2019 15:53:29 +0300
Message-Id: <20191021125329.29646-1-andriy.shevchenko@linux.intel.com>
...
---
 ...
 drivers/pinctrl/intel/pinctrl-tigerlake.c | 502 ++++++++++++++++++++++
...
index 000000000000..15dd973439a9
--- /dev/null
...
+	.groups = tgllp_community0_groups,
+	.ngroups = ARRAY_SIZE(tgllp_community0_groups),
+	.functions = tgllp_community0_functions,
+	.nfunctions = ARRAY_SIZE(tgllp_community0_functions),
...
+};
+
+static const struct intel_pingroup tgllp_community1_groups[] = {
+	/* PLACE HOLDER */
+};
+
+static const struct intel_function tgllp_community1_functions[] = {
+	/* PLACE HOLDER */
+};
+
...
+	.groups = tgllp_community1_groups,
+	.ngroups = ARRAY_SIZE(tgllp_community1_groups),
+	.functions = tgllp_community1_functions,
+	.nfunctions = ARRAY_SIZE(tgllp_community1_functions),
...
+};
+
+static const struct intel_pingroup tgllp_community4_groups[] = {
+	/* PLACE HOLDER */
+};
+
+static const struct intel_function tgllp_community4_functions[] = {
+	/* PLACE HOLDER */
+};
+
...
+	.groups = tgllp_community4_groups,
+	.ngroups = ARRAY_SIZE(tgllp_community4_groups),
+	.functions = tgllp_community4_functions,
+	.nfunctions = ARRAY_SIZE(tgllp_community4_functions),
...
+};
+
+static const struct intel_pingroup tgllp_community5_groups[] = {
+	/* PLACE HOLDER */
+};
+
+static const struct intel_function tgllp_community5_functions[] = {
+	/* PLACE HOLDER */
+};
+
...
+	.groups = tgllp_community5_groups,
+	.ngroups = ARRAY_SIZE(tgllp_community5_groups),
+	.functions = tgllp_community5_functions,
+	.nfunctions = ARRAY_SIZE(tgllp_community5_functions),
