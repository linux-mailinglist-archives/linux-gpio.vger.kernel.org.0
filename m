...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 34A416371D8
	for <lists+linux-gpio@lfdr.de>; Thu, 24 Nov 2022 06:46:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229448AbiKXFqG (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Thu, 24 Nov 2022 00:46:06 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56590 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229499AbiKXFqD (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Thu, 24 Nov 2022 00:46:03 -0500
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0B5EAC6884
        for <linux-gpio@vger.kernel.org>; Wed, 23 Nov 2022 21:46:00 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669268760; x=1700804760;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=/knPcQPTa+wRW0g3soR8hZKDUfDn7lmhxYYrMykp3oY=;
  b=G9XleT4vgTy4yUZRVd1fCO7BoL/Kz+ovqxga2VzV1CkaB0rP9HftKKdc
   On5z/VIn0QRwExyqIkDZPkOjAaEPnq8U5LOvqKUcALLpSYChL/usgVCJb
   jPTVyKxn+p+LCUq4gyJ6/oR1yWKT5TG75AZbjXu8j/FO/zhSZpC2+w5o8
   paHPBciX5s0dOtHOrX36KTXZ50KfRUKgkoq6Ve7XekYDv5zzmq5YJqBlZ
   +PQVFTBaPu8LpnNMcVXObW9S/mo6imhJ7sFJo/iyPr4eZFXDn0xWKqlEp
   zycRE5iP3ErysR9/Ci/wZ1VxyL0Qc0/Q1AnmXQ+xQdQazxJtwq6gsYERX
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10540"; a="314256146"
X-IronPort-AV: E=Sophos;i="5.96,189,1665471600"; 
   d="scan'208";a="314256146"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Nov 2022 21:45:59 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10540"; a="887224838"
X-IronPort-AV: E=Sophos;i="5.96,189,1665471600"; 
   d="scan'208";a="887224838"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by fmsmga006.fm.intel.com with ESMTP; 23 Nov 2022 21:45:57 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oy53c-0003Yb-24;
        Thu, 24 Nov 2022 05:45:56 +0000
Date:   Thu, 24 Nov 2022 13:45:19 +0800
...
Subject: [brgl:gpio/for-next 56/58] drivers/gpio/gpio-max732x.c:613:35:
 error: implicit declaration of function 'i2c_client_get_device_id' is
 invalid in C99
Message-ID: <202211241313.YpRXlfIY-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="mZTvNFKJT9pB1AVD"
...
config: x86_64-randconfig-r033-20221121
...
>> drivers/gpio/gpio-max732x.c:613:35: error: implicit declaration of function 'i2c_client_get_device_id' is invalid in C99 [-Werror,-Wimplicit-function-declaration]
   ...
   int i2c_get_device_id(const struct i2c_client *client,
       ^
   drivers/gpio/gpio-max732x.c:613:30: warning: incompatible integer to pointer conversion initializing 'const struct i2c_device_id *' with an expression of type 'int' [-Wint-conversion]
           const struct i2c_device_id *id = i2c_client_get_device_id(client);
                                       ^    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
