...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D0C3D2A2A9B
	for <lists+linux-gpio@lfdr.de>; Mon,  2 Nov 2020 13:21:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728423AbgKBMVM (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Mon, 2 Nov 2020 07:21:12 -0500
Received: from mga02.intel.com ([134.134.136.20]:30181 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728414AbgKBMVM (ORCPT <rfc822;linux-gpio@vger.kernel.org>);
        Mon, 2 Nov 2020 07:21:12 -0500
IronPort-SDR: vVD9IyNzpnr+CSAxiDJgiu4iy1tECt9hr42TLCNSZ4wvNuKDYhDVAAO6psNzvLSeBt/22vyGYv
 EdKM2SF+7xmg==
X-IronPort-AV: E=McAfee;i="6000,8403,9792"; a="155861663"
X-IronPort-AV: E=Sophos;i="5.77,444,1596524400"; 
   d="scan'208";a="155861663"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Nov 2020 04:21:11 -0800
IronPort-SDR: xgZ5OmjZxVJrH4WeHtSvSYp+rE77og/buU5rZiOBEhQYBroafeB1AfPWjpvLtXZMyExwwA6eqf
 ychjdszh1stw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,444,1596524400"; 
   d="scan'208";a="537999640"
Received: from black.fi.intel.com ([10.237.72.28])
  by orsmga005.jf.intel.com with ESMTP; 02 Nov 2020 04:21:09 -0800
Received: by black.fi.intel.com (Postfix, from userid 1003)
        id B2AD312A; Mon,  2 Nov 2020 14:21:08 +0200 (EET)
From:   Andy Shevchenko <andriy.shevchenko@linux.intel.com>
To:     Mika Westerberg <mika.westerberg@linux.intel.com>,
        linux-gpio@vger.kernel.org,
        Linus Walleij <linus.walleij@linaro.org>
Cc:     Andy Shevchenko <andriy.shevchenko@linux.intel.com>
Subject: [PATCH v1] pinctrl: intel: Add Intel Elkhart Lake pin controller support
Date:   Mon,  2 Nov 2020 14:21:07 +0200
Message-Id: <20201102122107.57687-1-andriy.shevchenko@linux.intel.com>
...
index fece44fd3ade..a646d869b156 100644
--- a/drivers/pinctrl/intel/Kconfig
+++ b/drivers/pinctrl/intel/Kconfig
@@ -106,6 +106,14 @@ config PINCTRL_DENVERTON
...
index 3f6007ff9209..5d4f6946a4d7 100644
--- a/drivers/pinctrl/intel/Makefile
+++ b/drivers/pinctrl/intel/Makefile
@@ -12,6 +12,7 @@ obj-$(CONFIG_PINCTRL_BROXTON)		+= pinctrl-broxton.o
