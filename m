...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4EF433AF5EB
	for <lists+linux-gpio@lfdr.de>; Mon, 21 Jun 2021 21:18:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231187AbhFUTU4 (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Mon, 21 Jun 2021 15:20:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39964 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231157AbhFUTUz (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Mon, 21 Jun 2021 15:20:55 -0400
Received: from mail-wr1-x432.google.com (mail-wr1-x432.google.com [IPv6:2a00:1450:4864:20::432])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A0865C061574
        for <linux-gpio@vger.kernel.org>; Mon, 21 Jun 2021 12:18:39 -0700 (PDT)
Received: by mail-wr1-x432.google.com with SMTP id h11so3414156wrx.5
        for <linux-gpio@vger.kernel.org>; Mon, 21 Jun 2021 12:18:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=bgdev-pl.20150623.gappssmtp.com; s=20150623;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=TES+qJTSC9neFyxIdHN4qC4HVYiiPp+i1i2YAE6zYhc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=TES+qJTSC9neFyxIdHN4qC4HVYiiPp+i1i2YAE6zYhc=;
        b=
X-Gm-Message-State: AOAM531+pHZNwIg99gwZZk/stYwe/xBWmSn+xR+kuJCqgH9JKxTEOeKZ
        vu+K4Zpy0eljUNgGMNssheSFxg==
X-Google-Smtp-Source: ABdhPJxXZjXIvH+8n9XtQ4NM6eJ9Jq8geeuT0kp0pgfcwxTa4lZmrLWBku4Rxckllg7YY0TPgLHS1Q==
X-Received: by 2002:a5d:5650:: with SMTP id j16mr13023681wrw.99.1624303116744;
        Mon, 21 Jun 2021 12:18:36 -0700 (PDT)
Received: from debian-brgl.home (lfbn-nic-1-146-78.w2-15.abo.wanadoo.fr. [2.15.229.78])
        by smtp.gmail.com with ESMTPSA id j34sm19438243wms.19.2021.06.21.12.18.36
...
Subject: [libgpiod][PATCH 4/4] bindings: cxx: implement C++ bindings for libgpiod v2.0
Date:   Mon, 21 Jun 2021 21:18:30 +0200
Message-Id: <20210621191830.10628-5-brgl@bgdev.pl>
...
---
 ...
 configure.ac                                |   1 +
 33 files changed, 2645 insertions(+), 1828 deletions(-)
...
+GPIOD_CXX_API const line_config chip::default_line_config = line_config();
+
+struct chip::impl
 {
...
+{
+	return this->_m_priv->events.capacity();
+}
+
...
+	auto vals = request.get_values(offsets);
...
+							       ::gpiod::line_config::no_output_values,
...
-		0
-	}, values);
+	request.set_values(offsets, values);
...
+} /* namespace */
+
+GPIOD_CXX_API const line_value_mappings line_config::no_output_values = line_value_mappings();
+
...
+}
+
+GPIOD_CXX_API line_config::line_config(int direction,
+				       const line_value_mappings& output_values,
+				       int edge, int bias, int drive, bool active_low,
+				       unsigned long debounce_period, int event_clock)
+	: _m_priv(new impl)
+{
...
+		throw ::std::invalid_argument("values must have the same size as the offsets");
+
+	int ret = ::gpiod_line_request_get_values(this->_m_priv->request.get(), offsets.size(),
+						  offsets.data(), values.data());
+	if (ret)
+		throw ::std::system_error(errno, ::std::system_category(),
...
+		throw ::std::invalid_argument("values must have the same size as the offsets");
+
+	int ret = ::gpiod_line_request_set_values(this->_m_priv->request.get(),
