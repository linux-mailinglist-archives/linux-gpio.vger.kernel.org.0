...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B68536134DE
	for <lists+linux-gpio@lfdr.de>; Mon, 31 Oct 2022 12:47:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230436AbiJaLrt (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Mon, 31 Oct 2022 07:47:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46498 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230454AbiJaLrs (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Mon, 31 Oct 2022 07:47:48 -0400
Received: from mail-pf1-x42a.google.com (mail-pf1-x42a.google.com [IPv6:2607:f8b0:4864:20::42a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9A771E0ED
        for <linux-gpio@vger.kernel.org>; Mon, 31 Oct 2022 04:47:45 -0700 (PDT)
Received: by mail-pf1-x42a.google.com with SMTP id i3so10429057pfc.11
        for <linux-gpio@vger.kernel.org>; Mon, 31 Oct 2022 04:47:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:references:in-reply-to
         ...
         :message-id:reply-to;
        bh=qsBFk66oWCr+PQ3BbXjiDBtrBhRPVWtqweEn/ym9N74=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=qsBFk66oWCr+PQ3BbXjiDBtrBhRPVWtqweEn/ym9N74=;
        b=
X-Gm-Message-State: ACrzQf1LiWpyK2pYtamkpOnrKdufWAV9crxz60ajLNHRZJfoFADNwcSf
        HnMPTUqnvRCv6UMFoxSyfVRnfw==
X-Google-Smtp-Source: AMsMyM4SPN7B3DfjsGuiRwfdETQbRipBXjTYuqmHq2Bg6AVOYX7T1j/xEf5/BuQZCidEarWt3YFAUg==
X-Received: by 2002:aa7:81cc:0:b0:563:4e53:c08b with SMTP id c12-20020aa781cc000000b005634e53c08bmr13935699pfn.19.1667216863944;
        Mon, 31 Oct 2022 04:47:43 -0700 (PDT)
Received: from localhost ([122.172.84.80])
        by smtp.gmail.com with ESMTPSA id w2-20020a623002000000b00561beff1e09sm4409961pfw.164.2022.10.31.04.47.42
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 31 Oct 2022 04:47:42 -0700 (PDT)
...
Subject: [libgpiod v2][PATCH V8 5/9] bindings: rust: Add libgpiod crate
Date:   Mon, 31 Oct 2022 17:17:13 +0530
Message-Id: <08d4095c314caf50430c2eaa733d925122242b12.1667215380.git.viresh.kumar@linaro.org>
...
new file mode 100644
index 000000000000..c9c01cd21feb
--- /dev/null
...
new file mode 100644
index 000000000000..95b05e947d26
--- /dev/null
...
+        // SAFETY: `gpiod_edge_event` is guaranteed to be valid here.
+        unsafe {
+            gpiod::gpiod_edge_event_get_global_seqno(self.event)
+                .try_into()
+                .unwrap()
+        }
+    }
...
+        // SAFETY: `gpiod_edge_event` is guaranteed to be valid here.
+        unsafe {
+            gpiod::gpiod_edge_event_get_line_seqno(self.event)
+                .try_into()
+                .unwrap()
+        }
+    }
...
new file mode 100644
index 000000000000..16d7022034df
--- /dev/null
...
new file mode 100644
index 000000000000..5452d47d51bc
--- /dev/null
...
new file mode 100644
index 000000000000..0f917fac383f
--- /dev/null
...
+
+impl Info {
+    fn new_internal(info: *mut gpiod::gpiod_line_info, from_event: bool) -> Result<Self> {
+        Ok(Self { info, from_event })
+    }
+
+    /// Get a snapshot of information about the line.
...
new file mode 100644
index 000000000000..10d2197b876a
--- /dev/null
