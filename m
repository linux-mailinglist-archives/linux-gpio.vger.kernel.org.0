...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1D5BE63675B
	for <lists+linux-gpio@lfdr.de>; Wed, 23 Nov 2022 18:38:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236647AbiKWRiz (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Wed, 23 Nov 2022 12:38:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58188 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238867AbiKWRij (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Wed, 23 Nov 2022 12:38:39 -0500
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D333A9A261
        for <linux-gpio@vger.kernel.org>; Wed, 23 Nov 2022 09:38:33 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669225113; x=1700761113;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=eWxPsszWyJPAtnYElQ4TBPYdLspghw4/QLNTWxqP8lY=;
  b=WWwusW5H/ZafuRfUIcMsUTKmBSb5ZHYlNuhGXA+Fcq4iqCWIhJKQsZRg
   oqIJ/VgZc+VJGcjcSYQqDy0emLD8h0VAj5sugN+3EJcu2GwFUocKN2JBd
   QJLTx+z7C5kCZeXWmYDH5nBWiIKpoDTyKOHMN9xOAzCZNPMIfCjBItJJy
   VQ9m0khFVf5qJ+Ix1V3cxE1GmBFNVV30p0YdtxufYmQP8lzz83d77N/0l
   74lVZ+DP2KptBsOgsmMIQjBnlKYNW+4srpFSZynGuStMH+y6rSuD2cHBE
   ZmFTg1Shdbcyd0RPH7nbc9XrMUu821rAYEeyogzRWtAzsQoVIs+ZbeNmQ
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10540"; a="312821719"
X-IronPort-AV: E=Sophos;i="5.96,187,1665471600"; 
   d="scan'208";a="312821719"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Nov 2022 09:38:33 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10540"; a="672952838"
X-IronPort-AV: E=Sophos;i="5.96,187,1665471600"; 
   d="scan'208";a="672952838"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by orsmga008.jf.intel.com with ESMTP; 23 Nov 2022 09:38:30 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oxthd-0002xF-1w;
        Wed, 23 Nov 2022 17:38:29 +0000
Date:   Thu, 24 Nov 2022 01:37:41 +0800
From:   kernel test robot <lkp@intel.com>
To:     Uwe =?iso-8859-1?Q?Kleine-K=F6nig?= 
        <u.kleine-koenig@pengutronix.de>
Cc:     oe-kbuild-all@lists.linux.dev, linux-gpio@vger.kernel.org,
        Bartosz Golaszewski <bartosz.golaszewski@linaro.org>
Subject: [brgl:gpio/for-next 57/58] drivers/gpio/gpio-pca953x.c:1054:46:
 warning: initialization of 'const struct i2c_device_id *' from 'int' makes
 pointer from integer without a cast
Message-ID: <202211240151.aXM3zcv6-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="GMGJg2OILakRaSQp"
...
All warnings (new ones prefixed by >>):
   ...
   drivers/gpio/gpio-pca953x.c:1054:46: error: implicit declaration of function 'i2c_client_get_device_id'; did you mean 'i2c_get_device_id'? [-Werror=implicit-function-declaration]
    1054 |         const struct i2c_device_id *i2c_id = i2c_client_get_device_id(client);
         |                                              ^~~~~~~~~~~~~~~~~~~~~~~~
         |                                              i2c_get_device_id
>> drivers/gpio/gpio-pca953x.c:1054:46: warning: initialization of 'const struct i2c_device_id *' from 'int' makes pointer from integer without a cast [-Wint-conversion]
