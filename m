...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EA4C5787EA9
	for <lists+linux-gpio@lfdr.de>; Fri, 25 Aug 2023 05:38:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239399AbjHYDiT (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Thu, 24 Aug 2023 23:38:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53006 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239424AbjHYDhz (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Thu, 24 Aug 2023 23:37:55 -0400
Received: from SHSQR01.spreadtrum.com (unknown [222.66.158.135])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B160C1BEF
        for <linux-gpio@vger.kernel.org>; Thu, 24 Aug 2023 20:37:50 -0700 (PDT)
Received: from dlp.unisoc.com ([10.29.3.86])
        by SHSQR01.spreadtrum.com with ESMTP id 37P3bDHD075861;
        Fri, 25 Aug 2023 11:37:13 +0800 (+08)
        (envelope-from linhua.xu@unisoc.com)
Received: from SHDLP.spreadtrum.com (shmbx04.spreadtrum.com [10.0.1.214])
        by dlp.unisoc.com (SkyGuard) with ESMTPS id 4RX5DP6kzpz2QTWfr;
        Fri, 25 Aug 2023 11:34:45 +0800 (CST)
...
Subject: [PATCH 4/6] pinctrl: sprd: Add pinctrl support for UMS512
Date:   Fri, 25 Aug 2023 11:18:24 +0800
Message-ID: <20230825031826.31599-5-Linhua.xu@unisoc.com>
...
X-MAIL: SHSQR01.spreadtrum.com 37P3bDHD075861
X-Spam-Status: No, score=-1.9 required=5.0 tests=BAYES_00,KHOP_HELO_FCRDNS,
        MAY_BE_FORGED,SPF_HELO_NONE,SPF_NONE,UPPERCASE_50_75 autolearn=no
...
---
 drivers/pinctrl/sprd/Kconfig               |  12 +
...
index eef35d01b770..e7eed4095d02 100644
--- a/drivers/pinctrl/sprd/Kconfig
+++ b/drivers/pinctrl/sprd/Kconfig
@@ -19,3 +19,15 @@ config PINCTRL_SPRD_SC9860
 	select PINCTRL_SPRD
 	help
...
index 000000000000..9ec64f58fba7
--- /dev/null
