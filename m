...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 320CF624033
	for <lists+linux-gpio@lfdr.de>; Thu, 10 Nov 2022 11:44:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229447AbiKJKob (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Thu, 10 Nov 2022 05:44:31 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39668 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230186AbiKJKoa (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Thu, 10 Nov 2022 05:44:30 -0500
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BCA765EF97
        for <linux-gpio@vger.kernel.org>; Thu, 10 Nov 2022 02:44:26 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1668077066; x=1699613066;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=RRt1DgZozbsbKFkDvM5enpAW875lYX2BFL8mUbyg4Go=;
  b=QBNY7WF1ifv/I37ipxJdtnAX1yZwt9Z1mIvi7h9hLhWie7W+sa7g6G18
   Kirj4RQcHp9+QfJtrTw9zuttELkVsPFEExJ+nhmmtn8Zk+IqTRyP2zeWB
   r6CgJGGNJTgWQ3PHu1ngsPbGKQuIQeznbhKfZ11SMfqQnnXVbHJJ80qYd
   EX++AKSejReANbHTNuewKRI+IFMDYymEQv+Iyr5yPFBrt0bNxOCUnbOIv
   yo3lQRNAxAbM5+H5xz8+aVxOpsk8sZ89CmU+nQQqNdT9890CQNcmqmabi
   vb0qFsACxC2RkaqK60aFFpYA4VrPTzrGsULKdhumPL1j5AXpkhqmSGt5u
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10526"; a="298775450"
X-IronPort-AV: E=Sophos;i="5.96,153,1665471600"; 
   d="scan'208";a="298775450"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Nov 2022 02:44:26 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10526"; a="615055328"
X-IronPort-AV: E=Sophos;i="5.96,153,1665471600"; 
   d="scan'208";a="615055328"
Received: from lkp-server01.sh.intel.com (HELO e783503266e8) ([10.239.97.150])
  by orsmga006.jf.intel.com with ESMTP; 10 Nov 2022 02:44:23 -0800
Received: from kbuild by e783503266e8 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ot52k-0002n3-1m;
        Thu, 10 Nov 2022 10:44:22 +0000
Date:   Thu, 10 Nov 2022 18:44:17 +0800
From:   kernel test robot <lkp@intel.com>
To:     Yinbo Zhu <zhuyinbo@loongson.cn>
Cc:     oe-kbuild-all@lists.linux.dev, linux-gpio@vger.kernel.org,
        Linus Walleij <linus.walleij@linaro.org>,
        zhanghongchen <zhanghongchen@loongson.cn>
Subject: [linusw-pinctrl:devel 21/30] include/asm-generic/io.h:1083:41:
 error: '_PAGE_IOREMAP' undeclared; did you mean 'VM_IOREMAP'?
Message-ID: <202211101830.PRNICjKM-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="b4DROT1eZx34W6/T"
...
head:   6e084248bdf915b1afbe1e9b643826a0e5ef7c89
...
>> include/asm-generic/io.h:1083:41: error: '_PAGE_IOREMAP' undeclared (first use in this function); did you mean 'VM_IOREMAP'?
    1083 |         return ioremap_prot(addr, size, _PAGE_IOREMAP);
         |                                         ^~~~~~~~~~~~~
         |                                         VM_IOREMAP
   include/asm-generic/io.h:1083:41: note: each undeclared identifier is reported only once for each function it appears in
...
vim +1083 include/asm-generic/io.h

80b0ca98f91ddb Christoph Hellwig 2019-08-13  1079  
80b0ca98f91ddb Christoph Hellwig 2019-08-13  1080  static inline void __iomem *ioremap(phys_addr_t addr, size_t size)
80b0ca98f91ddb Christoph Hellwig 2019-08-13  1081  {
80b0ca98f91ddb Christoph Hellwig 2019-08-13  1082  	/* _PAGE_IOREMAP needs to be supplied by the architecture */
80b0ca98f91ddb Christoph Hellwig 2019-08-13 @1083  	return ioremap_prot(addr, size, _PAGE_IOREMAP);
80b0ca98f91ddb Christoph Hellwig 2019-08-13  1084  }
80b0ca98f91ddb Christoph Hellwig 2019-08-13  1085  #endif /* !CONFIG_MMU || CONFIG_GENERIC_IOREMAP */
97c9801a15e5b0 Christoph Hellwig 2019-08-11  1086  
