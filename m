...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CEEAB60EB69
	for <lists+linux-gpio@lfdr.de>; Thu, 27 Oct 2022 00:13:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232528AbiJZWN1 (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Wed, 26 Oct 2022 18:13:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57710 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229880AbiJZWN0 (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Wed, 26 Oct 2022 18:13:26 -0400
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 828BDEB743
        for <linux-gpio@vger.kernel.org>; Wed, 26 Oct 2022 15:13:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666822402; x=1698358402;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=b5zc9D8WCUo7fxUcRPt984AGns8XH4j/FBXL1jtzzes=;
  b=dLdYGBBQTiGW5bheyiU7lzuKgJz6WTwiVIEK/swfUxvW8QJ2aYAp2rqr
   KTvEpL1r0f56PjY901E/MNGXEBOYjob8l/DBAyDqGAmFBzoWLRSRcO5rF
   ZIzucjnVwMAFTSNl8rC8yjP87EH9cUzVuRjuXyDZDCOQVcrXtW/EltmQt
   6s495MA/qE6aWjbDTvvHOKwGOe4LnHzPchfJKFYiw2y2OznnzYIsA7fbF
   NQJ4al+4PyffJhFXs55MhCDie0iYUWpthnmbr/2UGVSaV67A/vk0RtIb4
   dAHSOCOEPET1RXvSACo38gxB1rB6GcaEGu5f2YGxFxjLT++U9YKQVKOaG
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10512"; a="305686519"
X-IronPort-AV: E=Sophos;i="5.95,215,1661842800"; 
   d="scan'208";a="305686519"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Oct 2022 15:13:22 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10512"; a="721429234"
X-IronPort-AV: E=Sophos;i="5.95,215,1661842800"; 
   d="scan'208";a="721429234"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by FMSMGA003.fm.intel.com with ESMTP; 26 Oct 2022 15:13:18 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1onoeD-0007uA-1p;
        Wed, 26 Oct 2022 22:13:17 +0000
Date:   Thu, 27 Oct 2022 06:13:00 +0800
...
Message-ID: <202210270546.jDmS7Vyv-lkp@intel.com>
References: <9df1a016-36be-14b7-9674-d18c7df208c7@eilabs.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="U4ZnxBBQSydg0QYM"
...
>> drivers/gpio/gpio-pca953x.c:388:7: error: implicit declaration of function 'pca953x_has_int_mask' is invalid in C99 [-Werror,-Wimplicit-function-declaration]
   ...
   static inline bool pca953x_has_int_mask_reg(const struct pca953x_chip *chip)
                      ^
   drivers/gpio/gpio-pca953x.c:420:7: error: implicit declaration of function 'pca953x_has_int_mask' is invalid in C99 [-Werror,-Wimplicit-function-declaration]
                   if (pca953x_has_int_mask(chip))
                       ^
   2 errors generated.
