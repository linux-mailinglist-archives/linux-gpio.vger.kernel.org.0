Return-Path: <linux-gpio+bounces-32496-lists+linux-gpio=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-gpio@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id kD35JHZ0qGl6ugAAu9opvQ
	(envelope-from <linux-gpio+bounces-32496-lists+linux-gpio=lfdr.de@vger.kernel.org>)
	for <lists+linux-gpio@lfdr.de>; Wed, 04 Mar 2026 19:05:42 +0100
X-Original-To: lists+linux-gpio@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 7329A205B63
	for <lists+linux-gpio@lfdr.de>; Wed, 04 Mar 2026 19:05:42 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id CFAA4307A1D4
	for <lists+linux-gpio@lfdr.de>; Wed,  4 Mar 2026 18:02:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 231EC3E51E8;
...
X-Spamd-Result: default: False [2.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-32496-lists,linux-gpio=lfdr.de];
	URIBL_MULTI_FAIL(0.00)[sto.lore.kernel.org:server fail,intel.com:server fail,baylibre.com:server fail,nxp.com:server fail,glider.be:server fail,rock-chips.com:server fail,suse.de:server fail,tuxon.dev:server fail,ffwll.ch:server fail,pengutronix.de:server fail,bootlin.com:server fail,microchip.com:server fail,ideasonboard.com:server fail,linaro.org:server fail,kwiboo.se:server fail];
