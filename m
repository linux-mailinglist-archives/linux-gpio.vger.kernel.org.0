...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 47D42643AA1
	for <lists+linux-gpio@lfdr.de>; Tue,  6 Dec 2022 02:17:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230154AbiLFBRr (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Mon, 5 Dec 2022 20:17:47 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41274 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233056AbiLFBRq (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Mon, 5 Dec 2022 20:17:46 -0500
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ED5832DCB
        for <linux-gpio@vger.kernel.org>; Mon,  5 Dec 2022 17:17:40 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1670289460; x=1701825460;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=zbjIh6aDxuz484FqFaxYwkdsm2AtM/Yxu8jGBnFtJc4=;
  b=KaAsn1Q0ft6pvME3jrEPxutCFr7FLmQ1c0Briy5gycIiN0fL3dXQirNn
   B8EGJ03OY/D6hehpJrrEw546ar9g24RZWJ4+YaxVxUBEfps/X9C3VQpf8
   7Q/G94AB+FyQweFpPT63Vzcx2c64pc20m0yuIJt9qKh5nkzUVjwv6d1Pv
   y0W/VTkJkISHoYi8iTJQgFKSZbTbjmt2IkExLWti76UJRTUs77KrgOBl9
   kqq0virNvL5RDUJRB/ZD8BLSUcAhyQBbU2wNNle/lbviVByyROqAP71MO
   2+JimNw/5J0HUFwCNK6KgqEHzrNqhYH+a0TOvNUXUHfVxfAEARWXrHLEa
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10552"; a="318366852"
X-IronPort-AV: E=Sophos;i="5.96,220,1665471600"; 
   d="scan'208";a="318366852"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Dec 2022 17:17:39 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10552"; a="752427801"
X-IronPort-AV: E=Sophos;i="5.96,220,1665471600"; 
   d="scan'208";a="752427801"
Received: from lkp-server01.sh.intel.com (HELO b3c45e08cbc1) ([10.239.97.150])
  by fmsmga002.fm.intel.com with ESMTP; 05 Dec 2022 17:17:35 -0800
Received: from kbuild by b3c45e08cbc1 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p2MaU-0000TV-2d;
        Tue, 06 Dec 2022 01:17:34 +0000
Date:   Tue, 6 Dec 2022 09:16:39 +0800
...
Subject: [brgl:gpio/for-next 63/65]
 drivers/gpio/gpio-loongson-64bit.c:250:59: sparse: sparse: Using plain
 integer as NULL pointer
Message-ID: <202212060946.Ec9cF7hg-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="gOJOCn3SuCY6yc5C"
...
config: powerpc-randconfig-s033-20221206
...
>> drivers/gpio/gpio-loongson-64bit.c:250:59: sparse: sparse: Using plain integer as NULL pointer

vim +250 drivers/gpio/gpio-loongson-64bit.c
