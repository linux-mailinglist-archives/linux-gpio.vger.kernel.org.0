...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A3915636FC2
	for <lists+linux-gpio@lfdr.de>; Thu, 24 Nov 2022 02:22:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229502AbiKXBWz (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Wed, 23 Nov 2022 20:22:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54608 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229607AbiKXBWy (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Wed, 23 Nov 2022 20:22:54 -0500
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D427313F73
        for <linux-gpio@vger.kernel.org>; Wed, 23 Nov 2022 17:22:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669252969; x=1700788969;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=zQN9yXA61b6t1oA5ZcIJpsPpAIAy6/KVuont3novxrg=;
  b=L0ixFui+RTgQVTSeY1BCEhQdXbEjmCjw0JwzadO0u+j0EE547FvfDyqz
   +bm/nbmZRKoaD7ZPtiuqzjVlOUebUYfJmDT0a6qJhQ3FsIQNaGUSzrVeF
   T9V0G+E2HPc7k0+F2Q2YSNRaOTqpPKHJRFCfsBhghInSIsrqdHWY8QNOP
   1aKIf52Ipp9aPuQd3OrLjOXmlkm8fSNfsUYugAYvAlkQT8p5g3tBa0W9m
   DzRqSAQOWySfktXTg2v0A1qwqpZA078fdDUTAbhfPbP3oDXr/9Edo5kz0
   lUmNJvucI7Pqi/IS9Y8BQSzgBJmc87S97cxgmkewanRW9cI1hTRkbOp4e
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10540"; a="301753754"
X-IronPort-AV: E=Sophos;i="5.96,189,1665471600"; 
   d="scan'208";a="301753754"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Nov 2022 17:22:49 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10540"; a="971061249"
X-IronPort-AV: E=Sophos;i="5.96,189,1665471600"; 
   d="scan'208";a="971061249"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by fmsmga005.fm.intel.com with ESMTP; 23 Nov 2022 17:22:46 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oy0wv-0003K9-2H;
        Thu, 24 Nov 2022 01:22:45 +0000
Date:   Thu, 24 Nov 2022 09:22:44 +0800
...
Subject: [brgl:gpio/for-next 57/58] drivers/gpio/gpio-pca953x.c:1054:30:
 warning: incompatible integer to pointer conversion initializing 'const
 struct i2c_device_id *' with an expression of type 'int'
Message-ID: <202211240911.9RKa44Tn-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="szhW9ALMA6Vpyygy"
...
All warnings (new ones prefixed by >>):
   ...
   drivers/gpio/gpio-pca953x.c:1054:39: error: implicit declaration of function 'i2c_client_get_device_id' is invalid in C99 [-Werror,-Wimplicit-function-declaration]
   ...
   int i2c_get_device_id(const struct i2c_client *client,
       ^
>> drivers/gpio/gpio-pca953x.c:1054:30: warning: incompatible integer to pointer conversion initializing 'const struct i2c_device_id *' with an expression of type 'int' [-Wint-conversion]
           const struct i2c_device_id *i2c_id = i2c_client_get_device_id(client);
                                       ^        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   1 warning and 1 error generated.


vim +1054 drivers/gpio/gpio-pca953x.c
