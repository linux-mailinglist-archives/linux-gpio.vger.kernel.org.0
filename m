...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 727DC55AF35
	for <lists+linux-gpio@lfdr.de>; Sun, 26 Jun 2022 06:48:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233981AbiFZEsM (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Sun, 26 Jun 2022 00:48:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49122 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233799AbiFZEsK (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Sun, 26 Jun 2022 00:48:10 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 69DED64C8
        for <linux-gpio@vger.kernel.org>; Sat, 25 Jun 2022 21:48:08 -0700 (PDT)
X-UUID: 2622371a1baf4864b44052b1b8812cca-20220626
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.6,REQID:f1f40ef1-dcb1-4195-916d-e05e8cb16784,OB:0,LO
        B:20,IP:0,URL:0,TC:0,Content:0,EDM:0,RT:0,SF:45,FILE:0,RULE:Release_Ham,AC
        TION:release,TS:45
X-CID-INFO: VERSION:1.1.6,REQID:f1f40ef1-dcb1-4195-916d-e05e8cb16784,OB:0,LOB:
        20,IP:0,URL:0,TC:0,Content:0,EDM:0,RT:0,SF:45,FILE:0,RULE:Release_Ham,ACTI
        ON:release,TS:45
X-CID-META: VersionHash:b14ad71,CLOUDID:799891d8-850a-491d-a127-60d9309b2b3e,C
        OID:e019e7335b3d,Recheck:0,SF:28|17|19|48,TC:nil,Content:-5,EDM:-3,IP:nil,
        URL:1,File:nil,QS:nil,BEC:nil,COL:0
X-UUID: 2622371a1baf4864b44052b1b8812cca-20220626
Received: from mtkcas10.mediatek.inc [(172.21.101.39)] by mailgw02.mediatek.com
        (envelope-from <guodong.liu@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 497232305; Sun, 26 Jun 2022 12:48:03 +0800
Received: from mtkmbs07n1.mediatek.inc (172.21.101.16) by
 mtkmbs10n2.mediatek.inc (172.21.101.183) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id 15.2.792.3;
 Sun, 26 Jun 2022 12:48:02 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by
 mtkmbs07n1.mediatek.inc (172.21.101.16) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Sun, 26 Jun 2022 12:48:02 +0800
Received: from mhfsdcap04 (10.17.3.154) by mtkcas11.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Sun, 26 Jun 2022 12:48:01 +0800
Message-ID: <37cb3f3239c9be1dd18e576e4823f364679bb44a.camel@mediatek.com>
...
Date:   Sun, 26 Jun 2022 12:48:01 +0800
In-Reply-To: <202206260954.NjQGnygt-lkp@intel.com>
...
Cc: kbuild-all@lists.01.org, linux-gpio@vger.kernel.org, Linus Walleij
<linus.walleij@linaro.org>, Nícolas F. R. A. Prado <
nfraprado@collabora.com>
Subject: [linusw-pinctrl:devel 17/19] drivers/pinctrl/mediatek/pinctrl-
mt8192.c:1362:56: warning: "/*" within comment
...
commit: fe44e49840186c93ae26e3eda2c48c823fc7f33f [17/19] pinctrl:
...
W=1 O=build_dir ARCH=csky SHELL=/bin/bash drivers/pinctrl/mediatek/
...
> > drivers/pinctrl/mediatek/pinctrl-mt8192.c:1362:56: warning: "/*"
> > within comment [-Wcomment]

    1362 |         MTK_PULL_PU_PD_TYPE,/*100*
MTK_PULL_PU_PD_TYPE,/*101*/
         |                                                         
   drivers/pinctrl/mediatek/pinctrl-mt8192.c:1363:56: warning: "/*"
within comment [-Wcomment]
    1363 |         MTK_PULL_PU_PD_TYPE,/*102*
MTK_PULL_PU_PD_TYPE,/*103*/
         |                                                         
   drivers/pinctrl/mediatek/pinctrl-mt8192.c:1364:56: warning: "/*"
within comment [-Wcomment]
    1364 |         MTK_PULL_PU_PD_TYPE,/*104*
MTK_PULL_PU_PD_TYPE,/*105*/
         |                                                         
   drivers/pinctrl/mediatek/pinctrl-mt8192.c:1365:56: warning: "/*"
within comment [-Wcomment]
    1365 |         MTK_PULL_PU_PD_TYPE,/*106*
MTK_PULL_PU_PD_TYPE,/*107*/
         |                                                         
   drivers/pinctrl/mediatek/pinctrl-mt8192.c:1366:56: warning: "/*"
within comment [-Wcomment]
    1366 |         MTK_PULL_PU_PD_TYPE,/*108*
MTK_PULL_PU_PD_TYPE,/*109*/
         |                                                         
   drivers/pinctrl/mediatek/pinctrl-mt8192.c:1367:56: warning: "/*"
within comment [-Wcomment]
    1367 |         MTK_PULL_PU_PD_TYPE,/*110*
MTK_PULL_PU_PD_TYPE,/*111*/
         |                                                         
   drivers/pinctrl/mediatek/pinctrl-mt8192.c:1368:56: warning: "/*"
within comment [-Wcomment]
    1368 |         MTK_PULL_PU_PD_TYPE,/*112*
MTK_PULL_PU_PD_TYPE,/*113*/
         |                                                         
   drivers/pinctrl/mediatek/pinctrl-mt8192.c:1369:56: warning: "/*"
within comment [-Wcomment]
    1369 |         MTK_PULL_PU_PD_TYPE,/*114*
MTK_PULL_PU_PD_TYPE,/*115*/
         |                                                         
   drivers/pinctrl/mediatek/pinctrl-mt8192.c:1370:56: warning: "/*"
within comment [-Wcomment]
    1370 |         MTK_PULL_PU_PD_TYPE,/*116*
...
vim +1362 drivers/pinctrl/mediatek/pinctrl-mt8192.c
  ...
  1317		MTK_PULL_PUPD_R1R0_TYPE,/*10*/
MTK_PULL_PUPD_R1R0_TYPE,/*11*/
  1318		MTK_PULL_PUPD_R1R0_TYPE,/*12*/
MTK_PULL_PUPD_R1R0_TYPE,/*13*/
  1319		MTK_PULL_PUPD_R1R0_TYPE,/*14*/
MTK_PULL_PUPD_R1R0_TYPE,/*15*/
  ...
  1334		MTK_PULL_PU_PD_TYPE,/*44*/
MTK_PULL_PUPD_R1R0_TYPE,/*45*/
  1335		MTK_PULL_PUPD_R1R0_TYPE,/*46*/
MTK_PULL_PUPD_R1R0_TYPE,/*47*/
  1336		MTK_PULL_PUPD_R1R0_TYPE,/*48*/
MTK_PULL_PUPD_R1R0_TYPE,/*49*/
  1337		MTK_PULL_PUPD_R1R0_TYPE,/*50*/
MTK_PULL_PUPD_R1R0_TYPE,/*51*/
  1338		MTK_PULL_PUPD_R1R0_TYPE,/*52*/
MTK_PULL_PUPD_R1R0_TYPE,/*53*/
  1339		MTK_PULL_PUPD_R1R0_TYPE,/*54*/
MTK_PULL_PUPD_R1R0_TYPE,/*55*/
  1340		MTK_PULL_PUPD_R1R0_TYPE,/*56*/
...
> 1362		MTK_PULL_PU_PD_TYPE,/*100* MTK_PULL_PU_PD_TYPE,/*101*/
  ...
  1371		MTK_PULL_PU_PD_RSEL_TYPE,/*118*/
MTK_PULL_PU_PD_RSEL_TYPE,/*119*/
  1372		MTK_PULL_PU_PD_RSEL_TYPE,/*120*/
MTK_PULL_PU_PD_RSEL_TYPE,/*121*/
  1373		MTK_PULL_PU_PD_RSEL_TYPE,/*122*/
MTK_PULL_PU_PD_RSEL_TYPE,/*123*/
  1374		MTK_PULL_PU_PD_RSEL_TYPE,/*124*/
MTK_PULL_PU_PD_RSEL_TYPE,/*125*/
  ...
  1381		MTK_PULL_PU_PD_TYPE,/*138*/
MTK_PULL_PU_PD_RSEL_TYPE,/*139*/
  1382		MTK_PULL_PU_PD_RSEL_TYPE,/*140*/
MTK_PULL_PU_PD_RSEL_TYPE,/*141*/
  1383		MTK_PULL_PU_PD_RSEL_TYPE,/*142*/
MTK_PULL_PU_PD_TYPE,/*143*/
  ...
  1388		MTK_PULL_PUPD_R1R0_TYPE,/*152*/
MTK_PULL_PUPD_R1R0_TYPE,/*153*/
  1389		MTK_PULL_PUPD_R1R0_TYPE,/*154*/
MTK_PULL_PUPD_R1R0_TYPE,/*155*/
  ...
  1392		MTK_PULL_PU_PD_RSEL_TYPE,/*160*/
MTK_PULL_PU_PD_RSEL_TYPE,/*161*/
  ...
  1403		MTK_PULL_PU_PD_TYPE,/*182*/
MTK_PULL_PUPD_R1R0_TYPE,/*183*/
  1404		MTK_PULL_PUPD_R1R0_TYPE,/*184*/
MTK_PULL_PUPD_R1R0_TYPE,/*185*/
  1405		MTK_PULL_PUPD_R1R0_TYPE,/*186*/
MTK_PULL_PUPD_R1R0_TYPE,/*187*/
  1406		MTK_PULL_PUPD_R1R0_TYPE,/*188*/
MTK_PULL_PUPD_R1R0_TYPE,/*189*/
  1407		MTK_PULL_PUPD_R1R0_TYPE,/*190*/
MTK_PULL_PUPD_R1R0_TYPE,/*191*/
  1408		MTK_PULL_PUPD_R1R0_TYPE,/*192*/
MTK_PULL_PUPD_R1R0_TYPE,/*193*/
  1409		MTK_PULL_PUPD_R1R0_TYPE,/*194*/
MTK_PULL_PU_PD_TYPE,/*195*/
  ...
  1412		MTK_PULL_PU_PD_RSEL_TYPE,/*200*/
MTK_PULL_PU_PD_RSEL_TYPE,/*201*/
  1413		MTK_PULL_PU_PD_RSEL_TYPE,/*202*/
MTK_PULL_PU_PD_RSEL_TYPE,/*203*/
  1414		MTK_PULL_PU_PD_RSEL_TYPE,/*204*/
MTK_PULL_PU_PD_RSEL_TYPE,/*205*/
