...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7BEF960E5C0
	for <lists+linux-gpio@lfdr.de>; Wed, 26 Oct 2022 18:50:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233663AbiJZQuW (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Wed, 26 Oct 2022 12:50:22 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54084 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233816AbiJZQuS (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Wed, 26 Oct 2022 12:50:18 -0400
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8E8D736848
        for <linux-gpio@vger.kernel.org>; Wed, 26 Oct 2022 09:50:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666803012; x=1698339012;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=JT/SqNI6LdtKFOx8LYfMKtaKaIPuSiUiOo3vw6PQUqE=;
  b=ggbYmxAATYCnsBE07b35dWSUHV+8EEKI3N7WEW53wzWL9pOPAXTLFlQ9
   vkm747oyKl6Bbrf6kn8Ow8LrVX/hYLk/hJhGRAfcaz2UAmzlExWKYf2tY
   R9WnK5/L1tSwqyDga3WxZlveWaJ6VF7mGCH6wIpJ/JR7aMpz5ech27PSz
   m9lTvYnKTd/HTdP2IotCtjtNMpCKRhK3rVKVNCpVoc+8vufiwSolCxeo5
   t7R4SCt+RyYCdMWO33z7pdY/k8htG5pxwj6DqcTuPTx8ZtC/bbRpcirEy
   GauszciKqrfM1DKBXxuqPHKsci5yNcYdMe3CYm65oCjYTxslePePvQ55C
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10512"; a="306730542"
X-IronPort-AV: E=Sophos;i="5.95,215,1661842800"; 
   d="scan'208";a="306730542"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Oct 2022 09:50:10 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10512"; a="721333469"
X-IronPort-AV: E=Sophos;i="5.95,215,1661842800"; 
   d="scan'208";a="721333469"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by FMSMGA003.fm.intel.com with ESMTP; 26 Oct 2022 09:50:06 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1onjbM-0007dO-1O;
        Wed, 26 Oct 2022 16:50:00 +0000
Date:   Thu, 27 Oct 2022 00:49:11 +0800
...
Message-ID: <202210270010.vzaitY7X-lkp@intel.com>
References: <9df1a016-36be-14b7-9674-d18c7df208c7@eilabs.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="GfVY4Crw7L00bEuo"
...
config: csky-randconfig-r001-20221026
...
reproduce (this is a W=1 build):
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=csky SHELL=/bin/bash drivers/gpio/
...
All errors (new ones prefixed by >>):
   ...
   drivers/gpio/gpio-pca953x.c: In function 'pca953x_readable_register':
>> drivers/gpio/gpio-pca953x.c:388:21: error: implicit declaration of function 'pca953x_has_int_mask'; did you mean 'pca953x_has_int_mask_reg'? [-Werror=implicit-function-declaration]
     388 |                 if (pca953x_has_int_mask(chip))
         |                     ^~~~~~~~~~~~~~~~~~~~
   include/linux/compiler.h:58:52: note: in definition of macro '__trace_if_var'
      58 | #define __trace_if_var(cond) (__builtin_constant_p(cond) ? (cond) : __trace_if_value(cond))
         |                                                    ^~~~
   drivers/gpio/gpio-pca953x.c:388:17: note: in expansion of macro 'if'
     388 |                 if (pca953x_has_int_mask(chip))
         |                 ^~
   cc1: some warnings being treated as errors


vim +388 drivers/gpio/gpio-pca953x.c
