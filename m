Return-Path: <linux-gpio+bounces-34820-lists+linux-gpio=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-gpio@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id EPF3LMIf1Wnr0wcAu9opvQ
	(envelope-from <linux-gpio+bounces-34820-lists+linux-gpio=lfdr.de@vger.kernel.org>)
	for <lists+linux-gpio@lfdr.de>; Tue, 07 Apr 2026 17:16:18 +0200
X-Original-To: lists+linux-gpio@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [IPv6:2600:3c15:e001:75::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id B62DD3B0C73
	for <lists+linux-gpio@lfdr.de>; Tue, 07 Apr 2026 17:16:17 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 2EE6F300C343
	for <lists+linux-gpio@lfdr.de>; Tue,  7 Apr 2026 15:13:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B399035F5FD;
...
X-Spamd-Result: default: False [-1.01 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-34820-lists,linux-gpio=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[kernel@kempniu.pl,linux-gpio@vger.kernel.org];
	FORGED_RECIPIENTS_MAILLIST(0.00)[];
	MID_RHS_MATCH_FROMTLD(0.00)[];
	TAGGED_RCPT(0.00)[linux-gpio];
	RCPT_COUNT_SEVEN(0.00)[11];
	TO_DN_SOME(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[sin.lore.kernel.org:helo,sin.lore.kernel.org:rdns,larwa.hq.kempniu.pl:mid,kempniu.pl:dkim,kempniu.pl:email]
X-Rspamd-Queue-Id: B62DD3B0C73
