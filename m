...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1C38D2A07BB
	for <lists+linux-gpio@lfdr.de>; Fri, 30 Oct 2020 15:23:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725939AbgJ3OXS (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Fri, 30 Oct 2020 10:23:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33550 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725834AbgJ3OXS (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Fri, 30 Oct 2020 10:23:18 -0400
Received: from mail-wm1-x343.google.com (mail-wm1-x343.google.com [IPv6:2a00:1450:4864:20::343])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5A894C0613CF
        for <linux-gpio@vger.kernel.org>; Fri, 30 Oct 2020 07:23:17 -0700 (PDT)
Received: by mail-wm1-x343.google.com with SMTP id h22so3143284wmb.0
        for <linux-gpio@vger.kernel.org>; Fri, 30 Oct 2020 07:23:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=bgdev-pl.20150623.gappssmtp.com; s=20150623;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=j1V8cHQoecg9DycBFrBeP8LNlMAyq/ieGSL+HQrbSTA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=j1V8cHQoecg9DycBFrBeP8LNlMAyq/ieGSL+HQrbSTA=;
        b=
X-Gm-Message-State: AOAM533zhn5CTGP/quuVUCuQyKWXENsVd8qA+KHUhhIofufgNFoS9rrd
        DgWXPtJlM1+qJOWoQhKFz8Nhiw==
X-Google-Smtp-Source: ABdhPJw6JSXJ7eP2dU2xaY17cRnkP/eazXKljVpde6hWi1XQEUQl+2iV5UipqsNJeu0QH/rrjugXFw==
X-Received: by 2002:a1c:8095:: with SMTP id b143mr3044577wmd.147.1604067795366;
        Fri, 30 Oct 2020 07:23:15 -0700 (PDT)
Received: from debian-brgl.home (amarseille-656-1-4-167.w90-8.abo.wanadoo.fr. [90.8.158.167])
        by smtp.gmail.com with ESMTPSA id g186sm12708559wma.1.2020.10.30.07.23.13
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 30 Oct 2020 07:23:14 -0700 (PDT)
...
Subject: [libgpiod][PATCH v3] treewide: rework struct gpiod_line_bulk
Date:   Fri, 30 Oct 2020 15:23:12 +0100
Message-Id: <20201030142312.26754-1-brgl@bgdev.pl>
...
- drop bulk iterators in favor of looping over bulk indices
 ...
 bindings/python/gpiodmodule.c | 169 ++++++++++++++++---------
 include/gpiod.h               | 143 +++++++++------------
 lib/core.c                    | 211 +++++++++++++++++++------------
 lib/ctxless.c                 |  53 +++++---
 lib/helpers.c                 |  61 +++++----
 ...
 13 files changed, 759 insertions(+), 506 deletions(-)
...
@@ -106,11 +106,9 @@ void line_bulk::request(const line_request& config, const ::std::vector<int> def
...
-
 	...
 	conf.flags = 0;
@@ -120,7 +118,7 @@ void line_bulk::request(const line_request& config, const ::std::vector<int> def
...
+	rv = ::gpiod_line_request_bulk(bulk.get(),
 	...
 	if (rv)
@@ -132,25 +130,22 @@ void line_bulk::release(void) const
 {
 	this->throw_if_empty();
...
@@ -165,12 +160,10 @@ void line_bulk::set_values(const ::std::vector<int>& values) const
...
@@ -184,7 +177,7 @@ void line_bulk::set_config(int direction, ::std::bitset<32> flags,
...
+	auto bulk = this->to_line_bulk();
 	...
 	gflags = 0;
@@ -194,9 +187,7 @@ void line_bulk::set_config(int direction, ::std::bitset<32> flags,
 			gflags |= it.second;
 	}
...
+	rv = ::gpiod_line_set_config_bulk(bulk.get(), direction,
 	...
 	if (rv)
 		throw ::std::system_error(errno, ::std::system_category(),
@@ -207,11 +198,9 @@ void line_bulk::set_flags(::std::bitset<32> flags) const
 {
 	this->throw_if_empty();
...
@@ -219,7 +208,7 @@ void line_bulk::set_flags(::std::bitset<32> flags) const
 			gflags |= it.second;
 	}
...
@@ -229,12 +218,10 @@ void line_bulk::set_direction_input() const
 {
 	this->throw_if_empty();
...
@@ -247,13 +234,10 @@ void line_bulk::set_direction_output(const ::std::vector<int>& values) const
 	if (values.size() != this->_m_bulk.size())
 		throw ::std::invalid_argument("the size of values array must correspond with the number of lines");
...
@@ -263,27 +247,26 @@ line_bulk line_bulk::event_wait(const ::std::chrono::nanoseconds& timeout) const
 {
 	this->throw_if_empty();
...
+			ret.append(line(::gpiod_line_bulk_get_line(ev_bulk, i), chip));
 	...
 	return ret;
@@ -348,11 +331,19 @@ void line_bulk::throw_if_empty(void) const
...
+	unsigned int idx;
 	...
 	if (gpiod_LineBulkOwnerIsClosed(self))
@@ -1736,37 +1771,54 @@ static PyObject *gpiod_LineBulk_event_wait(gpiod_LineBulkObject *self,
 	ts.tv_sec = sec;
 	ts.tv_nsec = nsec;
...
@@ -2242,40 +2294,45 @@ static gpiod_LineBulkObject *
