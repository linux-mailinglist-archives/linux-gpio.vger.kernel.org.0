...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C91DA4BF760
	for <lists+linux-gpio@lfdr.de>; Tue, 22 Feb 2022 12:41:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231250AbiBVLlT (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Tue, 22 Feb 2022 06:41:19 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60806 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230384AbiBVLlT (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Tue, 22 Feb 2022 06:41:19 -0500
Received: from mail-pj1-x1029.google.com (mail-pj1-x1029.google.com [IPv6:2607:f8b0:4864:20::1029])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A887C136EF4
        for <linux-gpio@vger.kernel.org>; Tue, 22 Feb 2022 03:40:51 -0800 (PST)
Received: by mail-pj1-x1029.google.com with SMTP id v8-20020a17090a634800b001bb78857ccdso2180566pjs.1
        for <linux-gpio@vger.kernel.org>; Tue, 22 Feb 2022 03:40:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to;
        bh=r6IoXSotTAz0TjDEZrBVc8QKQ03GbpksHY6wBqMLr68=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=r6IoXSotTAz0TjDEZrBVc8QKQ03GbpksHY6wBqMLr68=;
        b=
X-Gm-Message-State: AOAM530rjpMs0wLATAYFy/YvG+BQ+ffpPFqhvW58qtb+BgxEQeGUn+80
        vFSxfqcCQ8dShqCwGIjzuXC3TytQewEENA==
X-Google-Smtp-Source: ABdhPJz2F2ngrewK5fykIDLrnNi4UnxhxOged7vUmBllOaItmo2kONZwyVqgYroSu7sBK5rZBV192g==
X-Received: by 2002:a17:90b:3cc:b0:1bc:692b:ad8 with SMTP id go12-20020a17090b03cc00b001bc692b0ad8mr3700786pjb.90.1645530050031;
        Tue, 22 Feb 2022 03:40:50 -0800 (PST)
Received: from sol (60-242-155-106.static.tpgi.com.au. [60.242.155.106])
        by smtp.gmail.com with ESMTPSA id o10-20020a17090a4e8a00b001bc778f4ea5sm2008415pjh.57.2022.02.22.03.40.46
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 22 Feb 2022 03:40:49 -0800 (PST)
Date:   Tue, 22 Feb 2022 19:40:44 +0800
...
This should be noted in the function documentation, not just here.
If only one place, then there not here.
...
Nitpicking here, but I prefer the

@param edge Type of edge events to detect.

style, that is an actual short description of the edge parameter, as used
above over

@param edge New edge detection setting.

as the latter is very bland boiler plate that doesn't really say
anything.

And can the @param edge description be consistent throughout all the
edge functions?

Similar elsewhere, on both points.

And again, this is being really nitpicky so feel free to leave it for a
subsequent doco tweaking pass.
