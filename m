...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 53AF34B97CA
	for <lists+linux-gpio@lfdr.de>; Thu, 17 Feb 2022 05:32:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233878AbiBQEce (ORCPT <rfc822;lists+linux-gpio@lfdr.de>);
        Wed, 16 Feb 2022 23:32:34 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:37026 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233860AbiBQEcb (ORCPT
        <rfc822;linux-gpio@vger.kernel.org>); Wed, 16 Feb 2022 23:32:31 -0500
Received: from mail-pj1-x1031.google.com (mail-pj1-x1031.google.com [IPv6:2607:f8b0:4864:20::1031])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A401688791
        for <linux-gpio@vger.kernel.org>; Wed, 16 Feb 2022 20:32:14 -0800 (PST)
Received: by mail-pj1-x1031.google.com with SMTP id qe15so4428385pjb.3
        for <linux-gpio@vger.kernel.org>; Wed, 16 Feb 2022 20:32:14 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to;
        bh=QiW8BbLtaOYPl4NFhzLrc5HcdlIrnkRe04E+GAJ6uwg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=QiW8BbLtaOYPl4NFhzLrc5HcdlIrnkRe04E+GAJ6uwg=;
        b=
X-Gm-Message-State: AOAM532ZiDg3aVNiOZ9KQTLhFXsBcQeGtIKEz9CWEwywwoRBOiJXIdhs
        KUTUImezJ5x5ZFCAnwS2opY=
X-Google-Smtp-Source: ABdhPJwDVpP1QBPhGRwHdF0FNzFPLk9s+NDBPhccsRSeogXhd5XGf2O8uUaPKKA0KkL70vZ53IRStA==
X-Received: by 2002:a17:90a:734c:b0:1b9:b1fa:db6a with SMTP id j12-20020a17090a734c00b001b9b1fadb6amr1224628pjs.158.1645072332625;
        Wed, 16 Feb 2022 20:32:12 -0800 (PST)
Received: from sol (60-242-155-106.static.tpgi.com.au. [60.242.155.106])
        by smtp.gmail.com with ESMTPSA id f7sm747753pfv.6.2022.02.16.20.32.08
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 16 Feb 2022 20:32:11 -0800 (PST)
Date:   Thu, 17 Feb 2022 12:32:06 +0800
...
Subject: Re: [libgpiod v2][PATCH 2/4] line-config: expose the override logic
 to users
Message-ID: <20220217043206.GB8970@sol>
References: <20220210140745.1059087-1-brgl@bgdev.pl>
 <20220210140745.1059087-3-brgl@bgdev.pl>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20220210140745.1059087-3-brgl@bgdev.pl>
...
On Thu, Feb 10, 2022 at 03:07:43PM +0100, Bartosz Golaszewski wrote:
...
The subset flavour has been removed.
And you don't describe the clear flavour.
...
What about the is_overridden check?
...
I find this paragraph confusing, which is especially worrying as it
starts with "It's important".  You are trying to reiterate that operations
on the config object are only manipulating the config object in memory and
are not applied to hardware until the request/reconfigure?

Cos I read it as meaning there is some difference between the offsets
used in line_config and the offsets on the chip.  And there isn't.
...
"simple cases" being where all lines have the same configuration so you
can just use the default setters.
So say that instead of "simple cases", which is open to interpretation.
...
Ignored return value in the only place set_kernel_attr_mask() is called.
If you aren't going to use the return value then set_kernel_attr_mask()
should skip over overrides for lines not in offsets, else you are
quietly truncating your config.

OTOH, if you want a strict "all lines in config must be in offsets" policy
then you need to check the return.

And set_kernel_output_values() behaviour should be consistent, either
way.

Document the behaviour in gpiod_line_request_reconfigure_lines() and
gpiod_chip_request_lines() and add corresponding test cases.
